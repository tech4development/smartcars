<!--starter-->
<div class="section hide-on-small-only" id="search" style="background-size: cover; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; width: 10    0%; margin-bottom: -180px; margin-top: -35px; background-color: #ccc;">
...
<div id="London" class="tabcontent" style="width: 100% !important; ">
  
 <div class="row">
    
        <form action="cars.php" method="POST">
                    <div class="col l0 s2">
                        <select id="make" class="browser-default" name="make" onchange="populate(this.id,'model')" style="width: 180px;" required>
    <option value="">Select Make</option>
   <option selected="New" value="">Select Make</option>
...
<option value="ZX Auto">ZX Auto</option>
           ...
           <div class="col l0 s2">
               ...
               <select id="model" name="model" class="browser-default" style="width: 180px; font-size: 16px;">
       ...
       <div class="col l3 s2">
      <input type="text" name="min_price" value="" placeholder="Minimum Price in Ksh"  style="width: 200px; color: #000;">
      </div>
     <div class="col l0 s2">
      <input type="text" name="max_price" value="" placeholder="Maximum Price in Ksh" style="width: 200px;">
      </div>
...
<div id="Paris" class="tabcontent">
 ...
 <div class="row">
     <form action="form.php" method="POST">
                    <div class="col l0 s2">
  <select id="make2" class="browser-default" onchange="populate(this.id,'model2')" style="width: 130px;">
    <option value="">Select Make</option>
   <option selected="New" value="">Select Make</option>
<optgroup label="Popular">
<option value="tuktuk">Tuktuk</option>
...
<option value="ZX Auto">ZX Auto</option>
           ...
           <div class="col l0 s2">
               ...
               <select id="model2" name="model" class="browser-default" style="width: 130px;">
                             <option selected="selected" value="">Select Model</option>
                           </select>
...
<div id="Tokyo" class="tabcontent">
 ...
 <div class="row">
     <form action="form.php" method="POST">
                    <div class="col l2 s2">
  <select id="make1" class="browser-default" onchange="populate(this.id,'model1')" style="width: 130px;">
    <option value="">Select Make</option>
   <option selected="New" value="">Select Make</option>
<optgroup label="Popular">
<option value="tuktuk">Tuktuk</option>
...
<select id="model1" name="model" class="browser-default" style="width: 180px; font-size: 16px;">
<option selected="selected" value="">Select Model</option>
</select>
      </div>
