<style>
    ...
    #makeP_1 {
        ...
        text-align: center;
        font: normal normal normal normal 20px / 24px "Hammersmith One", sans-serif;

        margin-top: -10px;
        margin-bottom: 2px;
    }/*#makeP_1*/

    #makeA_2, #makeA_3, #makeA_5, #makeA_7, #makeA_9, #makeA_11 {

        color: rgb(255, 240, 0);
        font: normal normal 700 normal 20px / 24px "Hammersmith One", sans-serif;
    }/*#makeA_2, #makeA_3, #makeA_5, #makeA_7, #makeA_9, #makeA_11*/

    #makeA_4, #makeA_6, #makeA_10 {
        color: rgb(255, 240, 0);
        font: normal normal 700 normal 20px / 24px "Hammersmith One", sans-serif;
    }/*#makeA_4, #makeA_6, #makeA_10*/
...
<div class="row blue" id="searchbymake" style="margin-top: 20px;   width: 90%;border-radius: 2px;">
    <h4 class="white-text" >Search by make</h4>
    <p id="makeP_1">
